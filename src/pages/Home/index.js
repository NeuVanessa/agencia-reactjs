          ...
          <main>
              ...
              <section className="login-cadastro">           
                ...
                <div className="busque-destinos">
                  ...
                  <Link to=""><img src="img/grecia.png" width="40px"/></Link>
                  <Link to=""><img src="img/alemanha.png" width="40px"/></Link> 
                  <Link to=""><img src="img/gra-bretanha.png" width="40px"/></Link> 
                  <Link to=""><img src="img/franca.png" width="40px"/></Link> 
